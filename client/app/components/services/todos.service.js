...
var TodosService = (function () {
    ...
    TodosService.prototype.getTodos = function () {
        ...
        return this._http.get('/api/v1/todos').map(function (data) { return data.json(); });
    };
    ...
    TodosService.prototype.deleteTodo = function (id) {
        return this._http.delete('/api/v1/todo/' + id).map(function (res) { res.json(); });
    };
    TodosService.prototype.updateStatus = function (todo) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this._http.put('/api/v1/todo/' + todo._id, JSON.stringify(todo), { headers: headers })
            .map(function (res) { return res.json(); });
